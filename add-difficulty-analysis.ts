...
async function addDifficultyAnalysis() {
  try {
    console.log('🔍 시험 조회...');
...
- 간접적이고 절제된 감정 표현`
    ...
    // Update questions with enhanced commentary
    const updatedQuestions = questionsData.map((q: any) => {
      const enhancement = difficultyEnhancements[q.questionNumber];
...
## 상/최상 난이도 문항 출제 경향 - 추론과 비판적 사고 요구
...
`
    ...
    console.log('✅ 난이도 분석 및 추가 해설 추가 완료!');
